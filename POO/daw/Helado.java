...
public class Helado {
    ...
    private static String conservante = "E233"; //variable global, se puede modificar
    private static int totalHelados = 0;
     ...
     public static void fijarConservante (String conservante) {
        Helado.conservante = conservante;
    }
